...
const universities = graduates.map(function(value){
...
const contactInfo = graduates.map(function(value){
  return `${value.first_name} ${value.email}`
});
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = universities.filter(function(value){
...
zooAnimals.forEach(function(value){
  return animalNames.push(`Name: ${value.animal_name}, Scientific: ${value.scientific_name}.`);
})
...
*/
const lowerPopulation = zooAnimals.filter(function(value){
